...
const ResponseAlert = () => {
  ...
  return (
    <div className="absolute left-0 top-0 z-[9999] flex h-screen w-full items-center justify-center">
      <div
        className={`relative flex h-[220px] w-[492px] items-center justify-center border-b border-4 bg-white text-[17px] shadow-xl ${isErrorMessage ? 'border-b-red' : 'border-b-green-500'
          }`}
      >
