  ...
  return (
    ...
    >
      <div
        ...
        } top-[45%] max-h-[95vh] w-full -translate-y-[50%] overflow-auto bg-white px-[37px] py-[40px] transition-all duration-700 scrollbar scrollbar-thin scrollbar-thumb-accent md:top-[50%] md:w-[480px] md:px-20`}
      >
        <button
          onClick={handleClose}
          type="button"
