...
export const contactsValidation = z.object({
  name: z
    ...
    .max(100, "Ім'я має містити максимум 100 символів"),
  ...
  phone: z
    .string({ required_error: 'Поле повинно бути заповнене' })
    .min(2, 'Номер телефону має містити мінімум 2 символи')
    .max(16, 'Номер телефону має містити максимум 16 символів')
